...
// .wrangler/tmp/bundle-CJpXuq/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-CJpXuq/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-CJpXuq/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    ...
    for (const source of parsedSources.sources || []) {
      if (source.src && source.kind === "normal") {
        streamsList.push({
          ...
          size_mb: 0,
          ext: "m3u8",
          url: source.src.startsWith("http") ? source.src : `https://hanime.tv${source.src}`
        });
      }
    }
